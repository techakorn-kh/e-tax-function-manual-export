pageextension 94005 "BWK Sales Credit Memo" extends "Sales Credit Memo"
{
    layout
    {
        addlast(content)
        {
            group("E-TAX")
            {
                ...
                field("BWK CN Purpost Code"; Rec."BWK CN Purpost Code")
                {
                    ApplicationArea = All;
                }
                field("BWK CN Purpost Name"; Rec."BWK CN Purpost Name")
                {
                    ApplicationArea = All;
                }
            }
