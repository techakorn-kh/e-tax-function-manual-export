codeunit 94000 "BWK E-Tax Function Center"
{
    ...
    begin
        ...
        if EtaxHeader.FindFirst() then begin
            if (EtaxHeader."BWK E-Tax Document Type" = EtaxHeader."BWK E-Tax Document Type"::INV) then begin
                CompanyInfo.Reset();
                CompanyInfo.get();
                ...
                if (EtaxHeader."BWK E-Tax Document Type" = EtaxHeader."BWK E-Tax Document Type"::DN) then begin
                    CompanyInfo.Reset();
                    CompanyInfo.get();
                    ...
                    if EtaxHeader."BWK E-Tax Document Type" = EtaxHeader."BWK E-Tax Document Type"::CN then begin
                        CompanyInfo.Reset();
                        CompanyInfo.get();
                        ...
                        if EtaxHeader."BWK E-Tax Document Type" = EtaxHeader."BWK E-Tax Document Type"::RV then begin
                            CompanyInfo.Reset();
                            CompanyInfo.get();
